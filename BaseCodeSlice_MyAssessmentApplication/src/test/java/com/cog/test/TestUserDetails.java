...
public class TestUserDetails {
	...
	/*
	 * //@Test public void transactionWithdrawal(){ long acc=1234l; double
	 * amt=10000.00; boolean isdeposit=false; TransactionDetails trans1=new
	 * TransactionDetails(8l,"test",false);
