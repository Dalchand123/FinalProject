...
public class ApplyHomeLoanTest {
	...
	public void setup() {
		...
		ud = new UserDetails(4161000100125568l, "Savings", "Rohit Sharma", 75000.0);
		homeloandetails = new HomeLoanDetails("HL-569", "1234567891234568", 300000l, d, 6000000l, "COgNi", "PA", 4, 6,
				ud, 10);
